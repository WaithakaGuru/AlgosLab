const CircularLinkedList = () => (
    <div className="space-y-6">
        ...
        <pre className="bg-[#e0e7ff] rounded-xl p-3 border-blue-600 border-2 my-8 text-md max-w-full break-words whitespace-pre-wrap overflow-x-auto">{`
...
`}</pre> 
        ...
        <section>
            ...
            <div className="flex flex-col items-center mb-4">
                <span className="font-mono text-sm text-slate-500 mb-1">Visual: Circular Singly Linked List</span>
    ...
    <section>
      ...
      <div className="flex flex-col items-center mb-4">
        <span className="font-mono text-sm text-slate-500 mb-1">Visual: Circular Doubly Linked List</span>
