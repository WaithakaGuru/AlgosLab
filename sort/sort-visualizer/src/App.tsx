...
function App() {
  ...
  const [insertionBoundary, setInsertionBoundary] = useState<number | null>(
    null,
  ); // for insertionSort
  ...
  return (
    ...
    >
      <AppBar
        position="static"
        sx={{ bgcolor: "darkslategray", width: "99%", boxShadow: "none" }}
      >
        <Toolbar>
          <Typography
            variant="h5"
            sx={{ flexGrow: 1, fontWeight: "bold", color: "skyblue" }}
          >
            Sorta
          </Typography>
        </Toolbar>
          ...
          >
            ...
            <Box>
              ...
              <Select
                ...
                sx={{ bgcolor: "white", height: "2.5rem", width: "9.5rem" }}
              >
